                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            <h5>Edit image</small></h5>
                        </div>
                        <div class="ibox-content">
                            <form method="post" enctype="multipart/form-data">
                                
                                <div class="form-group row @if($errors->has('name')) has-error @endif"><label class="col-sm-2 col-form-label ">Tên ảnh</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="name" value="{{$image->name}}"></div>
                                    @if($errors->has('name'))
